...
truth. Resolve any referenced files from the RepoLens repository root. RepoLens itself
must remain model-free; this wrapper only enables agents to create external proposal
artifacts that RepoLens later verifies and a human approves.
